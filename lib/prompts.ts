...
export function buildTailoringPrompt(resumeText: string, jobDescription: string, userNote?: string, writingSample?: string): string {
...
${VOICE_RULES}${buildVoiceBlock(writingSample)}`;
}
...
export function buildInterviewPrepPrompt(resumeText: string, jobDescription: string, writingSample?: string): string {
...
export function buildFollowUpPrompt(resumeText: string, jobDescription: string, writingSample?: string): string {
...
export function buildLinkedInHeadlinePrompt(resumeText: string, writingSample?: string): string {
