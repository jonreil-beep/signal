    ...
    <div className="flex flex-col gap-4 pb-4">
      <div className="flex flex-col sm:flex-row gap-2 max-w-md">
        <input
          ...
          className="flex-1 px-4 py-3 border border-brand-text/15 rounded-2xl sm:rounded-full text-base bg-white focus:outline-none focus:ring-2 focus:ring-brand-accent/30 focus:border-transparent"
        />
        <button
          onClick={handleSend}
