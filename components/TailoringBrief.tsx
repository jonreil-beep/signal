    ...
    <div className={`${bgClass} rounded-xl border border-[#E5E7EB] overflow-hidden`}>
      ...
      <div className="flex items-center justify-between px-5 py-4">
        ...
        {!isLoading && (
          <button
            onClick={onAction}
            className="shrink-0 text-[14px] font-[500] text-[#2E4057] hover:text-[#243445] transition-colors"
          >
          ...
          {noteValue !== undefined && onNoteChange && (
            <div className="border-t border-[#E5E7EB] pt-4 space-y-2">
              ...
              <textarea
                ...
                maxLength={300}
                rows={2}
                className="w-full text-[14px] text-[#374151] bg-[#F9FAFB] rounded-xl px-3 py-2.5 resize-none border border-[#E5E7EB] focus:border-[#2E4057] focus:outline-none focus:ring-0 placeholder:text-[#9CA3AF] leading-relaxed transition-colors"
              />
              <div className="flex justify-end">
                <button
                  onClick={onAction}
                  className="text-[14px] font-[500] text-[#2E4057] hover:text-[#243445] transition-colors"
                >
                  Re-generate →
                </button>
              </div>
            ...
            <div className="space-y-2">
              {result && (
                <textarea
                  ...
                  className="w-full text-[14px] text-[#374151] bg-[#F9FAFB] rounded-xl px-3 py-2.5 resize-none border border-[#E5E7EB] focus:border-[#2E4057] focus:outline-none focus:ring-0 placeholder:text-[#9CA3AF] leading-relaxed transition-all"
                />
              )}
          ...
          {result && !isGenerating && (
            <div className="grid grid-cols-1 lg:grid-cols-[58fr_42fr] gap-5">
              ...
              <div className="bg-white rounded-xl border border-[#E5E7EB] overflow-hidden divide-y divide-[#E5E7EB]">
                ...
                <div className="px-6 py-5">
                  ...
                  <div className="space-y-3">
                    {result.lead_strengths.map((s, i) => {
                      ...
                      return (
                        <div key={i} className="border-l-2 border-[#2E4057]/30 pl-3.5">
                ...
                <div className="px-6 py-5">
                  <div className="flex items-center justify-between mb-3">
                    <p className="text-[12px] font-[500] tracking-[0.05em] uppercase text-[#A86B2D]">
                      ⚑ Recruiter Concern to Preempt
                    </p>
                ...
                <div className="px-6 py-5">
                  ...
                  <div className="space-y-2.5">
                    {result.what_to_deemphasize.map((d, i) => (
                      <div key={i} className="border-l-2 border-[rgba(168,107,45,0.40)] pl-3.5">
              ...
              >
                {cr && (
                  <>
                    ...
                    {cr.caveat && (
                      <div className="rounded-xl bg-[rgba(196,98,45,0.05)] border border-[rgba(196,98,45,0.15)] px-4 py-3">
                        <p className="text-[13px] text-[#C4622D] leading-snug">{cr.caveat}</p>
                      </div>
                    )}
                      ...
                      <div className="border-t border-[#E5E7EB] pt-6">
                        ...
                        <div className="space-y-3">
                          {cr.red_flags_to_probe.map((f, i) => (
                            <div key={i} className="rounded-xl bg-[rgba(196,98,45,0.04)] border border-[rgba(196,98,45,0.12)] px-4 py-3 space-y-1">
                              <p className="text-[13px] font-[500] text-[#C4622D]">{f.flag}</p>
